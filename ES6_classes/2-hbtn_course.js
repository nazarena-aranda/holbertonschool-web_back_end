export default class HolbertonCourse {
  constructor(name, length, students) {
    ...
    if (!students.every((s) => typeof s === 'string')) throw new TypeError('Each student must be a string');
  ...
  set students(value) {
    ...
    if (!value.every((s) => typeof s === 'string')) throw new TypeError('Each student must be a string');
